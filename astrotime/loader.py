...
v1 supports CSV only, since that's what most beginner-friendly
astronomical datasets (including TESS exports via lightkurve) end up
as once you've done any preprocessing. Add more formats (FITS, etc.)
here later -- this module is the single place that should know how to
turn "a file on disk" into a LightCurve.
"""
