...
Every function here takes a matplotlib Axes as an optional argument
and returns the Axes it drew on, rather than calling plt.show()
itself. This is a deliberate convention, not an accident: it lets you
compose multiple plots into one figure (e.g. raw + folded side by
side) and it keeps this module usable in a script, a notebook, or a
test, without forcing a GUI window to pop up in any of them.
"""
...
def plot_autocorrelation(
    ...
    """Plot the autocorrelation function vs. lag, with the best period marked.
